...
const YAMetrika = () => {
  ...
  useEffect(() => {
    //@ts-ignore
    ym(94961323, "hit", window.location.href);
  ...
  return (
    ...
    ym(94961323, 'init', {webvisor:true, clickmap:true, referrer: document.referrer, url: location.href, accurateTrackBounce:true, trackLinks:true});
      `}
      </Script>
      {/* <script
