...
8. **ЗАКЛЮЧИТЕЛЬНЫЕ ПОЛОЖЕНИЯ**
   ...
   8.2. Настоящей Политикой утверждена форма Согласия на обработку персональных данных пользователей Сайта (Приложение №1 к настоящей Политике), которая размещается на Сайте в публичном доступе по ссылке: https://terraholod.ru/docs/pd-consent.
...
Адрес электронной почты: **igusev@terra-holod.ru**

Телефон: **+7 (8342) 30-33-55**
`;
